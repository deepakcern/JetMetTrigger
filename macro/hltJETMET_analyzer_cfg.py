...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:output.root')#/afs/cern.ch/work/d/dekumar/public/JETMET_Work/depthStudeis/CMSSW_10_6_1_patch1/src/HLTrigger/Configuration/test/hltoutput.root')
)
...
process.depthEnergy = cms.EDAnalyzer("depthEnergyAnalyzer",
	...
	pfMetRaw=cms.InputTag("hltPFMETProducer","","TEST"),
        ...
        depthenergyLabel = cms.InputTag('depthEnergy'),
...
process.out = cms.OutputModule("PoolOutputModule",
                               fileName = cms.untracked.string('test_ntuples.root'),
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("ntuples_analyzer.root")
                                   )
