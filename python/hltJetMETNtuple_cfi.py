    ...
    process.hltJetMetNtuple = cms.EDAnalyzer('HLTJetMETNtupleProducer',
               ...
               HLTPFMetCollectionTag = cms.InputTag('hltPFMETProducer'),
					     ...
					     HLTPFMetTag = cms.InputTag('hltPFMETProducer'),
                                             ...
                                             eleMvaIsoIdWP80Map = cms.InputTag("egmGsfElectronIDs:mvaEleID-Fall17-iso-V1-wp80"),
                                             eleMvaIsoIdWP90Map = cms.InputTag("egmGsfElectronIDs:mvaEleID-Fall17-iso-V1-wp90"),
                                             eleMvaIsoIdwpLooseMap = cms.InputTag("egmGsfElectronIDs:mvaEleID-Fall17-iso-V1-wpLoose"),
                                             mvaFall17IsoValuesMap = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Fall17IsoV1Values"),


                                             eleFall17VetoIdMap = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-Fall17-94X-V1-veto"),
                                             eleFall17LooseIdMap = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-Fall17-94X-V1-loose"),
                                             eleFall17MediumIdMap = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-Fall17-94X-V1-medium"),
                                             eleFall17TightIdMap = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-Fall17-94X-V1-tight"), 
